...
const aboutMeTextContent ="Um pequeno portfólio para mostrar meus conhecimentos e experiências. Espero poder ter a chance de integrar uma das melhores equipes profissionais do Brasil ((:";
...
Array.from(aboutMeTextContent).forEach((char) => {
  ...
  span.addEventListener("mouseenter", (e) => {
    e.target.style.animation = "aboutMeTextAnim";
  });
});
...
projects.forEach((project, i) => {
  ...
  project.addEventListener("click", () => {
    ...
    bigImg.setAttribute("src", `${imgPath}-big.jpeg`);
...
const subject = document.getElementById("Sujeito");
const message = document.getElementById("Mensagem");
const messages = document.querySelectorAll(".messagem");
...
const checkEmail = (input) => {
  ...
  if (regEx.test(input.value.trim())) {
    ...
    error(input, "Email não é valido");
  }
};
